 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://healthcaresystem.me.org/", wsdlLocation = "http://localhost:8080/Login/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://healthcaresystem.me.org/", "Login");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://healthcaresystem.me.org/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://healthcaresystem.me.org/", "LoginPort"), Login.class, features);
    }
